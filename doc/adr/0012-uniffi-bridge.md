...
- Status: **Accepted & implemented** — supersedes [ADR-0002](0002-json-string-jni-bridge.md). The
  hand-written JSON JNI bridge is removed; the host drives a typed `HyperStack` and the whole
  surface is typed (object props included, as an `ObjectProps` record). No JSON crosses the bridge.
- Date: 2026-06-17
